...
def schedule_main(file_path, plotter, storage):
    ...
    while True:
        try:
            ...
            bot_type=7, rt=True, freeze=13, forced_patience=True, stop_loss_pips=5, take_profit_pips=15, pip_value=0.0001, target_rr_ratio=3, code_multiplier=1,
            log_file="temp_files/last_action_log_5_minutes_bot.txt", trailing_stop_loss=True,
            advisors_threshold=2, web_scraping="15m")
