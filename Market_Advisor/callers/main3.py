...
def schedule_main(file_path, plotter, storage):
    ...
    while True:
        try:
            ...
            bot_type=7, rt=True, freeze=13, forced_patience=True, stop_loss_pips=10, take_profit_pips=30, pip_value=0.0001, target_rr_ratio=3, code_multiplier=3,
            log_file="temp_files/last_action_log_30_minutes_bot.txt", trailing_stop_loss=True,
            advisors_threshold=2, web_scraping="1h")
